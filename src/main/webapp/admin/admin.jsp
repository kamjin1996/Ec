...
<body>
	...
	<div style="width: 80%;margin-left: 10%;">
		...
		<ul id="top_right" class="collapse navbar-collapse nav navbar-nav navbar-right"	style="margin-right: 20px;">
			<li>
				<a href="#">
					<span class="badge"	style="background-color: red;">${sysUser.username}</span>
				</a>
			</li>
			<li>
				<a href="/loginOut.do">
		...
		<div class="page_main">
			<script type="text/javascript">
				...
				$("#showGoodsType").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/admin/showGoodsType.jsp");
				})
				...
				$("#showGoods").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/admin/showGoods.jsp");
				})
				$("#addGoods").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/admin/addGoods.jsp");
				})
